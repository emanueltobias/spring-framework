package com.emanueltobias.drinks.mail;
...
public class Mailer {
	...
	public void enviar(Venda venda) {
		...
		try {
			...
			helper.setFrom("drinks@emanueltobias.com");
			helper.setTo(venda.getCliente().getEmail());
			helper.setSubject(String.format("Drinks - Venda n° %d", venda.getCodigo()));
			...
			for (String cid : fotos.keySet()) {
				...
				byte[] arrayFoto = fotoStorege.recuperarThumbnail(foto);
