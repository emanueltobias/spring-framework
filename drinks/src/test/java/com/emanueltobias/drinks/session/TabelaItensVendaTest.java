package com.emanueltobias.drinks.session;
...
import com.emanueltobias.drinks.session.TabelaItensVenda;
...
public class TabelaItensVendaTest {
	...
	@Test
	public void deveExclutirItem() throws Exception {
		Cerveja c1 = new Cerveja();
		c1.setCodigo(1L);
		c1.setValor(new BigDecimal("8.99"));
		
		Cerveja c2 = new Cerveja();
		c2.setCodigo(2L);
		c2.setValor(new BigDecimal("4.50"));
		
		Cerveja c3 = new Cerveja();
		c3.setCodigo(3L);
		c3.setValor(new BigDecimal("1.00"));
		...
		assertEquals(new BigDecimal("9.99"), tabelaItensVenda.getValorTotal());
	}
